		...
		<nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
			<div class="flex flex-1">
				<a href="/" class="-m-1.5 p-1.5">
					<span class="sr-only">Svelte Platforms</span>
					<img
						class="h-8 w-auto"
			...
			<div class="flex flex-1 justify-end items-center gap-6">
				...
				<a
					...
					>{$page.data.user ? 'Go to app' : 'Log in'} <span aria-hidden="true">&rarr;</span></a
				>
			</div>
		</nav>
	</header>
...
<div class="bg-white py-24 sm:py-32">
	<div class="mx-auto max-w-7xl px-6 lg:px-8">
		<div class="mx-auto max-w-2xl lg:text-center">
			<h2 class="text-base font-semibold leading-7 text-indigo-600">Get started today</h2>
			<p class="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
				Everything you need to setup your next multi-tenant app
			</p>
			<p class="mt-6 text-lg leading-8 text-gray-600">Built on the shoulders of giants.</p>
		</div>
